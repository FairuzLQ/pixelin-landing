...
const projects = [
  {
    ...
    desc: "Platform sosial anonim buatan Pixelin sendiri. Pengguna bisa post konten, kasih reaksi, kirim DM — tanpa perlu identitas nyata. Dibangun full-stack dengan sistem autentikasi anonim yang aman.",
    icon: Globe,
    category: "Social Platform",
    accentColor: "#22d3ee",
    tags: ["Full-stack", "Anonymous Auth", "Real-time", "Social Feed"],
  ...
  },
  {
    ...
    desc: "Bukan sekadar landing page — ini toko online jasa pemasangan dashcam lengkap dengan katalog produk, sistem pemesanan, dan pembayaran manual yang terstruktur. Pengunjung bisa pilih produk, pesan, dan bayar langsung lewat website.",
    icon: Car,
    category: "E-Commerce",
    accentColor: "#f59e0b",
    tags: ["E-Commerce", "Katalog Produk", "Sistem Order", "WhatsApp CTA"],
  ...
  },
  {
    ...
    desc: "Company profile alat berat yang serius. Ada katalog produk lengkap, fitur pencarian dan filter produk, plus tampilan yang memancarkan kepercayaan untuk klien B2B skala besar. Bukan sekadar profil — ini sales tool.",
    icon: Building2,
    category: "Company Profile",
    accentColor: "#6366f1",
    tags: ["Company Profile", "Product Catalog", "Search & Filter", "B2B"],
