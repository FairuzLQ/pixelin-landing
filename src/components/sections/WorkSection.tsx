...
const projects = [
  ...
  },
  {
    ...
    desc: "Bukan sekadar landing page — ini toko online lengkap. Pengunjung bisa browsing katalog dashcam, pilih produk, dan langsung checkout dengan sistem pemesanan yang terstruktur dan mudah digunakan.",
    icon: Car,
    category: "E-Commerce",
    accentColor: "#f59e0b",
  ...
  },
  {
    ...
    desc: "Company profile alat berat yang serius. Katalog produk lengkap dengan fitur pencarian dan filter — klien bisa temukan alat yang mereka butuhkan dengan cepat. Tampilan yang memancarkan kepercayaan untuk segmen B2B skala besar.",
    icon: Building2,
